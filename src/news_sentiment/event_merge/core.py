...
def _should_merge(left: NormalizedNews, right: NormalizedNews) -> bool:
    if left.source in {"hkex", "fed", "ecb", "boe", "boc_press", "boj", "fedreg_sec", "fedreg_ofac", "bis", "sec_press", "investing_news", "investing_forex", "investing_economic"} or right.source in {"hkex", "fed", "ecb", "boe", "boc_press", "boj", "fedreg_sec", "fedreg_ofac", "bis", "sec_press", "investing_news", "investing_forex", "investing_economic"}:
